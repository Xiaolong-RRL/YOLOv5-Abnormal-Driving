...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='Arial.ttf', pil=False, example='abc'):
        # def __init__(self, im, line_width=None, font_size=None, font='Arial.ttf', pil=False, example='人工智能'):
        ...
        if self.pil:  # use PIL
            ...
            self.font = check_pil_font(font='Arial.Unicode.ttf' if is_chinese(example) else font,
                                       size=font_size or max(round(sum(self.im.size) / 2 * 0.035), 36))
        else:  # use cv2
            self.im = im
